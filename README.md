...
![Create Board](img/Strive_CreateBoard.png)
...
* **Comprehensive Kanban Boards:**
    * **Sections/Columns Management:** Create custom sections (columns) to represent stages in your workflow.
    ...
    ![Section](img/Strive_Section.png)
